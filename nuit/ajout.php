...
$sql= "INSERT INTO user (nom,prenom,login,password,idrole,email) VALUES ('$nom','$prenom','$login','$password','$idrole','$email')";
...
if(mysqli_query($connect,$sql)){
 ...
 echo "<p><h6 ><em> Nouveau user ajouté avec succès</h6></em></p>";
